...
using Test.DemoApp.Forms.Droid;
using Test.DemoApp.Forms.Droid.BroadcastReceiver;
using Xamarin.Forms;

namespace Test.DemoApp.Droid
{
	[Activity(Label = "Test.DemoApp.Droid", Icon = "@drawable/icon", Theme = "@style/MyTheme", MainLauncher = true, ConfigurationChanges = ConfigChanges.ScreenSize | ConfigChanges.Orientation)]
